...
const Hero = () => {
  ...
  useEffect(() => {
      console.log(`loaded videos: ${loadedVideos} out of ${totalVideos}`)
                ...
                onStart: () => {
                    ...
                    if (playPromise !== undefined) {
                        playPromise.catch(error => {
                            ...
                            // You might want to update UI or state here if needed
                        });
                    }
                },
            })
    ...
    return (
        <div className={'relative h-dvh w-screen overflow-x-hidden'}>
            ...
            <h1 className={'special-font hero-heading text-blue-400 absolute bottom-5 right-5'}>
                rew<b>a</b>rds
            </h1>
        </div>
    )
